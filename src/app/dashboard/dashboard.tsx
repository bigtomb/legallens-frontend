              ...
              <CardContent className="text-left">
                ...
                <div className="mt-4 flex items-start p-4 bg-blue-50 rounded-md">
                  ...
                  <p className="text-sm text-blue-700">
                    LegalLens AI is designed to assist legal professionals, but it does not replace professional legal
                    advice. Always review AI-generated content carefully and consult with qualified legal experts for
                    critical decisions.
                  </p>
                </div>
              </CardContent>
